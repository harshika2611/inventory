const { insertCustomerQuery, getCustomersQuery, updateCustomerQuery, deleteCustomerQuery } = require('../../service/manageCustomers/manageCustomers.js');
...
async function updateCustomer(req, res) {
  try {
    const customerDetails = req.body;
    const updateCustomerStatus = await updateCustomerQuery(customerId, customerDetails);
...
module.exports = { insertCustomer, updateCustomer, getCustomers, deleteCustomer, filterCustomer }