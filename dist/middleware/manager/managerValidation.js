    ...
    for (let key in managerDetails) {
        switch (key) {
            case 'firstname':
                ...
                else if (managerDetails[key].trim().length === 0 &&
                    managerDetails[key] !== '') {
                    managerFormError[key] = '* Please Enter Firstname';
                }
                else if (managerDetails[key].trim().length < 3 &&
                    managerDetails[key] !== '') {
                    managerFormError[key] = '* Please valid firstname';
                }
                else if (managerDetails[key].trim().length > 45 &&
                    managerDetails[key] !== '') {
                    managerFormError[key] = '* Please valid firstname';
                }
                else {
            ...
            case 'lastname':
                ...
                else if (managerDetails[key].trim().length > 15 &&
                    managerDetails[key] !== '') {
                    managerFormError[key] = '* Please valid Lastname';
                }
                else {
            ...
            case 'email':
                ...
                else if (!regexemail.test(managerDetails[key]) &&
                    managerDetails[key] !== '') {
...
exports.default = manageManagerFormValidation;
