...
exports.productValidation = exports.orderValidation = void 0;
    ...
    for (let key in insertFormData) {
        switch (key) {
            ...
            case 'amount':
                ...
                else if (insertFormData[key].trim().length === 0 &&
                    insertFormData[key] !== '') {
            ...
            case 'date':
                if (insertFormData[key].length === 0) {
                    ...
                    isNaN(parseInt(new Date(insertFormData[key]).toDateString()))) {
    ...
    for (let key in productFormData) {
        switch (key) {
            ...
            case 'quantity':
                ...
                else if (productFormData[key].trim().length === 0 &&
                    productFormData[key] !== '') {
