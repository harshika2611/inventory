...
import { getForgot, forgotPass } from '../controller/login/forgot';
import loginFormValidation from '../middleware/login/loginValidation';
import forgotFormValidation from '../middleware/login/forgotValidation';
...
import { getStoreCombo, getCityCombo } from '../controller/manager/manager';
...
import {
  ...
  listManagers,
  updateManager,
} from '../controller/manager/manager';
import manageManagerFormValidation from '../middleware/manager/managerValidation';
router.get(
  '/manager',
  passport.authenticate('jwt', { session: false, failureRedirect: '/' }),
  checkRole,
...
import {
  getCity,
  getState,
} from '../controller/commonFunctions/commonFunctions';
...
import {
  ...
  getsalesReport,
} from '../controller/report/salesReport';
import {
  getpurchaseReport,
  getApiproductPurchasereport,
} from '../controller/report/purchaseReport';
...
} from '../controller/report/orderReport';

import {
  reportPdfPage,
  productReportGenerate,
  outOfStockProducts,
} from '../controller/report/reportPdf';

import { getCombosDetails } from '../controller/commonFunctions/commonFunctions';
...
import {
  dashboard,
  getApiproductStock,
} from '../controller/dashboard/dashboard';
router.get(
  '/dashboard',
  passport.authenticate('jwt', { session: false, failureRedirect: '/' }),
  dashboard
...
import {
  orderValidation,
  productValidation,
} from '../middleware/salesModule/salesValidation';
...
import {
  ...
  deleteCustomer,
  reactivateCustomer,
} from '../controller/manageCustomers/manageCustomers';
...
import {
  ...
  storeProducts,
  deleteStoreProduct,
} from '../controller/stores/store';
import storeValidation from '../middleware/store/storeValidation';
...
router.get(
  '/api/reactivateCategory/:categoryId',
  passport.authenticate('jwt', { session: false, failureRedirect: '/' }),
  reactivateCategory
);
router.get(
