...
const { getHome } = require('../controller/home/homeController.js');
const { auth } = require('../../middleware/auth.js');
const { getForgot, forgotPass } = require('../controller/login/forgot.js');
...
const {
  ...
  fetchPurchases,
  deletePurchase,
} = require('../controller/purchase/index.js');
