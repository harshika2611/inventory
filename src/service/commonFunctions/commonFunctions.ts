...
async function getStateQuery() {
  try {
    ...
    const [result] = await connection.execute<RowDataPacket[]>(getStateQuery);
    // info(result);
    return result;
  } catch (error) {
    logError('Get State: ' + error);
    throw error;
    // return [];
  }
}

async function getCityQuery(stateName: string) {
  try {
    ...
    logError('Get City: ' + error);
    throw error;
    // return [];
  }
}

async function getCityStateId(stateName: string, cityName: string) {
  try {
    ...
    logError('Get State and City Id: ' + error);
    throw error; //rethrow
    // return [];
  }
}
...
async function getAllCityState() {
  try {
    ...
    const [result] = await connection.execute<RowDataPacket[]>(
      getAllCityStateIdQuery
    );
    // info(result);
    return result;
  } catch (error) {
    logError('Get All State and City: ' + error);
    throw error; //rethrow
    // return [];
  }
}

export { getStateQuery, getCityQuery, getCityStateId, getAllCityState };
